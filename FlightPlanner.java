...
public class FlightPlanner extends ConsoleProgram {
	...
	/*Asks user for the name of the next city in the route*/
	...
	/* given a starting city, looks up the destinations from that city in the HashMap of flights, and return
	 * an array list of the destinations that are available
	 */
	...
	/* reads in the city information from the given file storing the information in both the arrayList of cities
	 * and the HashMap of flights
	 */
	 ...
	 * fromCity -> toCity. Each new city is added to the ArrayList cities, and each new flight is recorded
	 * by adding a new destination city to the ArrayList stored in the HashMap flights under the key for the
	 * starting city.*/
	...
	/* defines a city if it has not already been defined. Defining a city consists of entering it in the
	 * cities array and entering an empty ArrayList in the flights table to show that it has no destinations yet */
